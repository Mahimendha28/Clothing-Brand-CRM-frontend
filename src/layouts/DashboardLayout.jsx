              ...
              {visibleCrmNavItems.map((item) => {
                ...
                return (
                  <NavLink
                    key={item.label}
                    to={item.to}
                    className={`group flex items-center justify-between rounded-xl px-3 py-2 text-sm font-medium transition-all duration-200 ${isActive
            ...
            <nav className="space-y-1.5">
              {customerNavItems.map((item) => (
                <NavLink
                  ...
                  className={({ isActive }) =>
                    `flex items-center justify-between p-3 rounded-xl text-sm font-medium transition-all ${isActive || item.match(location.pathname)
          ...
          <div className="mb-6 flex gap-3 overflow-x-auto pb-2 md:hidden">
            {customerNavItems.map((item) => (
              <NavLink
                ...
                className={({ isActive }) =>
                  `whitespace-nowrap rounded-full border px-4 py-2 text-sm font-medium transition-all ${isActive || item.match(location.pathname)
